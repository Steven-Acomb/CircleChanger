...
class CircleChanger(object):
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        self.circle.fill_color = self.colors[random.randint(0,
                                                            len(
                                                                self.colors)-1)]
    ...
    def swell_or_shrink_repeatedly(self,
        ...
        for k in range(times_to_swell_or_shrink):
            CircleChanger.swell_or_shrink_once(self, amount_to_swell_or_shrink)
            CircleChanger.draw(self)
            CircleChanger.swell_or_shrink_once(
                self, -1*amount_to_swell_or_shrink)
            CircleChanger.draw(self)
    ...
    def swallow(self, other_circle_changer):
        ...
        return(CircleChanger((self.circle.center.x
                          +other_circle_changer.circle.center.x)/2,
                          (self.circle.center.y
                          +other_circle_changer.circle.center.y)/2,
                          0.5*self.get_distance_from(
            other_circle_changer.circle.center), 'red',
    ...
    def change_to_original_color(self):
        ...
        self.circle.fill_color = self.init_color
    ...
    def change_to_next_color_in_tuple(self):
        ...
        ################################################################
        self.circle.fill_color = self.colors[self.col_index]
        self.col_index += 1
        if(self.col_index == len(self.colors)):
            self.col_index = 0
